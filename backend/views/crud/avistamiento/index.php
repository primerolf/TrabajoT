...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="table-responsive">
        ...
        'columns' => [
			...
			'id_terreno'=>[
             'header'=>'Terreno', 
             'value'=>function($data){return $data->terrenos->nom_terreno;},
            ],
			'id_clima'=>[
             'header'=>'Clima', 
             'value'=>function($data){return $data->climas->nom_clima;},
            ],
			'cantidad',
			'id_region',
			'id_usuario'=>[
			...
			'id_taxonomia'=>[
             'header'=>'Taxonomia', 
             'value'=>function($data){return $data->Taxonomia->nombre_taxo;},
            ],
        ],
        ]); ?>
    </div>

...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\models\search\Terreno $searchModel
*/

$this->title = Yii::t('models', 'Terrenos');
...
?>
<div class="giiant-crud terreno-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="table-responsive">
        ...
        'columns' => [
            ...
            'region'=>[
                'header'=>'Region',
                'value'=>function($data){return $data->region->nom_region;},
            ],
           ],
        ]); ?>
    </div>
